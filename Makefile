...
railwaylib.o: railwaylib.c
	gcc railwaylib.c -c -o railwaylib.o `pkg-config --cflags gtk+-3.0 gstreamer-1.0 gstreamer-pbutils-1.0` -Wall

railwaymusic.o: railwaymusic.c
	gcc railwaymusic.c -c -o railwaymusic.o `pkg-config --cflags gtk+-3.0 gstreamer-1.0` -Wall

railway: railway.o railwaylib.o railwaymusic.o railwayplaylist.o
	gcc railway.o railwaylib.o railwaymusic.o railwayplaylist.o -o railway `pkg-config --libs gtk+-3.0 gstreamer-1.0 gstreamer-pbutils-1.0` -pthread -Wall
